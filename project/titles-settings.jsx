    ...
    <div data-screen-label="Settings" style={{ padding: "24px 32px 56px", maxWidth: 880, margin: "0 auto" }}>
      ...
      <SettingsSection title="Danger zone" eyebrow="Destructive" tone="danger">
        <SettingsRow
          ...
          desc="Clear all BeepBeep AI-generated titles and meta descriptions from your site. This cannot be undone."
      ...
      {isPro ? (
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14, flexWrap: "wrap" }}>
          ...
          <div className="tnum" style={{ fontSize: 11.5, color: "var(--text-3)" }}>
            <span className="mono" style={{ color: "var(--text-2)", fontWeight: 500 }}>{used}</span> pages improved this cycle
...
const DEBUG_EVENTS = [
  { time: "3:42 pm", level: "info",  msg: "Plugin initialised — 138 pages indexed" },
  { time: "3:41 pm", level: "debug", msg: "API request started — POST /api/title-meta" },
