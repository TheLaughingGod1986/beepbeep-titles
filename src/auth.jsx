...
export const SignOutConfirm = ({ open, onCancel, onConfirm }) => (
    <Modal open={open} onClose={onCancel} width={420}>
        <div style={{ padding: '22px 24px 20px' }}>
            ...
            <h2 style={{ fontSize: 18, fontWeight: 600, letterSpacing: '-0.015em', margin: '0 0 6px' }}>Sign out?</h2>
            <p style={{ fontSize: 13, color: 'var(--text-2)', margin: 0, lineHeight: 1.55 }}>
                Auto-generate will pause until you return. All previously generated titles and meta descriptions stay on your site.
            </p>
