/* BeepBeep AI — Autopilot screen (Titles & meta)
   How BeepBeep writes page titles and meta descriptions, and when it runs.
   Hero status + tone + length controls + live SERP preview + scheduled work. */

const PRESETS = [
  {
    id: "direct",
    label: "Direct",
    desc: "Plain, factual phrasing. Best for utility pages, docs, support.",
    sampleTitle: "Cappuccino & Latte Art Tutorials | Mission Coffee",
    sampleMeta:  "Learn cappuccino, latte, and macchiato techniques from our downtown baristas. Step-by-step guides, photos, and short videos for any home espresso machine.",
  },
  {
    id: "benefit",
    label: "Benefit-led",
    desc: "Leads with the outcome. Higher click-through on commercial pages.",
    sampleTitle: "Make Cafe-Quality Cappuccino at Home in 6 Minutes",
    sampleMeta:  "Stop paying $6 a cup. Our barista-tested method gets you silky foam and balanced espresso every morning — with whatever espresso machine you already own.",
  },
  {
    id: "authoritative",
    label: "Authoritative",
    desc: "Credibility signals. Good for guides, cornerstone content, longform.",
    sampleTitle: "The Complete Guide to Cappuccino Latte Art (2026)",
    sampleMeta:  "From milk temperature to free pours — the definitive cappuccino guide trusted by 40,000 home baristas. Written by Mission Coffee's head trainer, updated for 2026.",
  },
  {
    id: "conversational",
    label: "Conversational",
    desc: "Friendly and human. Lowers click-friction on blog content.",
    sampleTitle: "Cappuccino, but actually good — at home",
    sampleMeta:  "We've spent ten years tuning latte art for our cafe. Here's everything we'd tell a friend who's about to buy their first espresso machine. No gatekeeping.",
  },
];
...
const trimToChars = (text, max) => {
  ...
  // Trim to last whole word within the cap.
...
const AutopilotScreen = ({ plan, autoOptimise, onAutoToggle, onUpgrade, onToast }) => {
  ...
  const [style, setStyle] = React.useState("direct");
  const [titleLen, setTitleLen] = React.useState("standard");
  const [metaLen, setMetaLen]   = React.useState("standard");
    ...
    <div data-screen-label="Autopilot" style={{ padding: "24px 32px 56px", maxWidth: 960, margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: 18 }}>
        ...
        <p style={{ fontSize: 13, color: "var(--text-2)", margin: "4px 0 0", maxWidth: 580, lineHeight: 1.5 }}>
          Decide how BeepBeep AI writes page titles and meta descriptions — and let it run quietly in the background every time you publish.
        </p>
      </div>
      ...
      <SectionTitle eyebrow="Generation" title="How BeepBeep AI writes" subtitle="These preferences apply to every page — manual and automated."/>
      ...
      {/* LIVE PREVIEW — Google SERP snippet */}
      <SERPPreviewCard preset={preset} title={previewTitle} meta={previewMeta} instructions={instructions}/>

      {/* SCHEDULED WORK (Pro) */}
      <SectionTitle eyebrow="Run on a schedule" title="Background work" subtitle="Optional Pro extras that keep your site SEO healthy without you opening BeepBeep AI."/>
        ...
        <ScheduleRow
          ...
          onChange={() => {
            ...
            if (next && onToast) onToast({
              message: "Daily crawl enabled",
              sub: "BeepBeep AI will sweep your pages every morning at 6 am.",
        ...
        <ScheduleRow
          ...
          onChange={() => {
            ...
            if (next && onToast) onToast({
              ...
              sub: "Sample alert: 3 pages on /blog may be off-topic after recent edits.",
              icon: "bell", tone: "warn",
            });
          }}
        />
    ...
    <Card padding={0} style={{ marginBottom: 22, borderColor: on ? "var(--ok-border)" : "var(--border)" }}>
      <div style={{ padding: "16px 20px", display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontSize: 12.5, color: "var(--text-2)", lineHeight: 1.45 }}>
            {on
              ? "BeepBeep AI will write a title & meta description for every page the moment it goes live."
              : "Turn this on so you never have to think about title & meta again."}
          </div>
        </div>
      ...
      {on && (
        <div className="fade-in" style={{
          ...
          <HeroStat label="Optimised, last 24h" value="8 pages"/>
          <HeroStat label="Avg generation time" value="2.4s"/>
  ...
  <Card padding={0} style={{ marginBottom: 22, background: "var(--surface-2)" }}>
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 7, whiteSpace: "nowrap" }}>
        ...
        <span style={{ fontSize: 11, color: "var(--text-3)", fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", whiteSpace: "nowrap" }}>Search result preview</span>
      </div>
    ...
    <div style={{ padding: "18px 22px" }}>
      ...
      <div style={{
        ...
        {/* Site row: favicon + name + URL breadcrumb */}
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", lineHeight: 1.2, minWidth: 0 }}>
            <span style={{ fontSize: 13, color: "#202124", fontFamily: "arial, sans-serif" }}>Mission Coffee</span>
            <span style={{ fontSize: 12, color: "#5f6368" }}>https://missioncoffee.com › guides › cappuccino</span>
          </div>
        </div>

        {/* Title — Google's blue heading */}
        <div key={title} style={{
        ...
        {/* Meta description — Google's gray body */}
        <div key={meta} style={{
          ...
          <span style={{ color: "#70757a", marginRight: 4 }}>May 20, 2026 —</span>
          {meta}
        </div>
      </div>
